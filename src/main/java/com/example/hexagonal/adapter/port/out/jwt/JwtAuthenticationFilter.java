...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(ValidateTokenPort validateTokenPort) {
    ...
    protected void doFilterInternal(
        ...
        if (token != null && validateTokenPort.isValid(token)) {
            String subject = validateTokenPort.getSubject(token);
