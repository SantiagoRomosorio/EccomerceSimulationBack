...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleDomainException(
        ...
        ApiStatusCode status = statusFor(exception);
    ...
    public ResponseEntity<ApiResponse<Object>> handleMissingHeader(
        ...
        return responseFactory.error(
                ...
                "Missing trusted identity header",
                "The request must pass through api-gateway so X-User-* headers are injected",
                Map.of("headerName", exception.getHeaderName()),
                request
        );
    }
